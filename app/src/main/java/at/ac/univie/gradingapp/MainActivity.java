...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,SchoolclasslistFragment.OnFragmentInteractionListener, SubjectListFragment.OnFragmentInteractionListener, StudentListFragment.OnFragmentInteractionListener, BulkAddFragment.OnFragmentInteractionListener  { //Drawer und Schoolclasslist als Starscreen
    //1
    ///2
